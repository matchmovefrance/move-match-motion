...
import { MapPin, Building, ArrowUp, Car } from 'lucide-react';
        ...
        <Tabs defaultValue="basic" className="w-full">
          ...
          <TabsContent value="departure" className="space-y-3">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-medium">Configuration du lieu de départ</span>
            </div>
          ...
          <TabsContent value="arrival" className="space-y-3">
            <div className="flex items-center gap-2 mb-3">
              <Building className="h-4 w-4" />
              <span className="font-medium">Configuration du lieu d'arrivée</span>
            </div>
